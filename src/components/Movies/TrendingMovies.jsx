...
function TrendingMovies() {
  ...
  const slideLeftTrendingMovies = () => {
    const slider = document.getElementById('sliderTrendingMovies');
  ...
  const slideRightTrendingMovies = () => {
    const slider = document.getElementById('sliderTrendingMovies');
    const card = document.querySelector('.card');
    const computedStyle = window.getComputedStyle(card);
    const cardWidth = card.offsetWidth + parseFloat(computedStyle.marginRight);
    ...
    <>
      ...
      <div className="main-slider-container">
        <MdChevronLeft
          ...
          onClick={slideLeftTrendingMovies}
        />
        <div className="cardz" id="sliderTrendingMovies">
        ...
        <MdChevronRight
          ...
          onClick={slideRightTrendingMovies}
        />
      </div>
    </>
  );
