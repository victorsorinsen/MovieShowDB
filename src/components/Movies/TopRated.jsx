...
function TopRated() {
  ...
  const slideLeftTopRated = () => {
    const slider = document.getElementById('sliderTopRated');
  ...
  const getDataFromServer = function () {
    fetch(
      'https://api.themoviedb.org/3/movie/top_rated?api_key=6a77f5a2cdf1a150f808f73c35533a92'
    )
      .then((r) => r.json())
      .then((data) => {
    ...
    <>
      ...
      <div className="main-slider-container">
        <MdChevronLeft
          ...
          onClick={slideLeftTopRated}
        />
        <div className="cardz" id="sliderTopRated">
