...
function TopRatedSeries() {
  ...
  const slideLeftTopRatedSeries = () => {
    const slider = document.getElementById('sliderTopRatedSeries');
  ...
  const slideRightTopRatedSeries = () => {
    const slider = document.getElementById('sliderTopRatedSeries');
    const card = document.querySelector('.card');
    const computedStyle = window.getComputedStyle(card);
    const cardWidth = card.offsetWidth + parseFloat(computedStyle.marginRight);
  ...
  const getDataFromServer = function () {
    fetch(
      'https://api.themoviedb.org/3/tv/top_rated?api_key=6a77f5a2cdf1a150f808f73c35533a92'
    )
      .then((r) => r.json())
      .then((data) => {
    ...
    <>
      ...
      <div className="main-slider-container">
        <MdChevronLeft
          ...
          onClick={slideLeftTopRatedSeries}
        />
        <div className="cardz" id="sliderTopRatedSeries">
        ...
        <MdChevronRight
          ...
          onClick={slideRightTopRatedSeries}
        />
      </div>
    </>
  );
