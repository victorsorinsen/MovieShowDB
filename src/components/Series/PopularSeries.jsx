...
function PopularSeries() {
  ...
  const slideLeftPopularSeries = () => {
    const slider = document.getElementById('sliderPopularSeries');
  ...
  const getDataFromServer = function () {
    fetch(
      'https://api.themoviedb.org/3/tv/popular?api_key=6a77f5a2cdf1a150f808f73c35533a92'
    )
      .then((r) => r.json())
      .then((data) => {
    ...
    <>
      ...
      <div className="main-slider-container">
        <MdChevronLeft
          ...
          onClick={slideLeftPopularSeries}
        />
        <div className="cardz" id="sliderPopularSeries">
        ...
        <MdChevronRight
          ...
          onClick={slideRightPopularSeries}
        />
      </div>
    </>
  );
