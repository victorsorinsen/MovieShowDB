...
function TrendingSeries() {
  ...
  const slideLeftTrendingSeries = () => {
    const slider = document.getElementById('sliderTrendingSeries');
  ...
  const slideRightTrendingSeries = () => {
    const slider = document.getElementById('sliderTrendingSeries');
    const card = document.querySelector('.card');
    const computedStyle = window.getComputedStyle(card);
    const cardWidth = card.offsetWidth + parseFloat(computedStyle.marginRight);
  ...
  const getDataFromServer = function () {
    fetch(
      'https://api.themoviedb.org/3/trending/tv/day?api_key=6a77f5a2cdf1a150f808f73c35533a92'
    )
      .then((r) => r.json())
      .then((data) => {
    ...
    <>
      ...
      <div className="main-slider-container">
        <MdChevronLeft
          ...
          onClick={slideLeftTrendingSeries}
        />
        <div className="cardz" id="sliderTrendingSeries">
        ...
        <MdChevronRight
          ...
          onClick={slideRightTrendingSeries}
        />
      </div>
    </>
  );
