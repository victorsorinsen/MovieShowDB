...
export const addItemToWatchlist = async (item) => {
  try {
    const watchlist = await addDoc(collection(db, auth.currentUser.uid), {
      item,
    });
  } catch (e) {
    console.error(e);
...
export const deleteItemFromWatchlist = async (docId) => {
...
export { movieGenreArray };

const showGenreArray = [
  {
    id: 10759,
